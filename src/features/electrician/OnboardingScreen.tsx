...
const s = StyleSheet.create({
  ...
  languageCard: { marginTop: 12, paddingTop: 16, paddingBottom: 4, paddingHorizontal: 14 },
  ...
  sectionEyebrow: { color: '#7D8AA5', fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.1, marginBottom: 6 },
